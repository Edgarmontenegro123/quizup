import {getBGColor} from "@/app/components/questionCard/helpers";
...
const QuestionCard = ({currentQuestionIndex, question, answers, userAnswer, correctAnswer, onClick} : Props) => (
    <div>
        <p className="text text-[25px] font-bold max-w-[400px]" dangerouslySetInnerHTML={{__html: question}} />
            ...
            {answers.map(answer => (
                <div
                    ...
                    className={
                        ...
                        cursor-pointer flex items-center justify-center select-none font-bold min-h-[45px] max-w-[400px] w-full my-2 rounded-[10px]`
                    }
                >
